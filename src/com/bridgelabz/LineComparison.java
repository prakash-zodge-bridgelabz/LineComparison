...
public class LineComparison {
    public static void main(String[] args) {
        ...
        LineComparison UC_3 = new LineComparison();
        UC_3.UC_3_CheckWhetherLinesAreEqualOrGreaterOrSmallerUsingCompareTo();
    }
    ...
    public void UC_3_CheckWhetherLinesAreEqualOrGreaterOrSmallerUsingCompareTo(){
        Scanner sc = new Scanner(System.in);
        // Input for the first point
        System.out.println("Enter first line details : ");
        System.out.print("Enter x1: ");
